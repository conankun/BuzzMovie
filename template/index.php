								...
								<script>
									...
									function validation() {
										$.ajax({
											...
											data: {id:$("#id").val(), name:$('#name').val(), email:$('#email').val(), pw:$('#pw').val(), repw:$('#repw').val(), }
...
<div class="banner">
	<div class="header" style="padding-bottom:0;">	
			<div class="logo">
			   <h1><a href="index.php"><i><img src="images/cell.png" alt=" " /></i>BuzzMovie</a></h1>
			</div>
			<div class="top-nav">
				<span class="menu"><img src="images/menu.png" alt=" " /></span>
				<ul class="nav1" style="display:inline-block;float:right;">
					<li><a href="#" data-toggle="modal" data-target="#myModal" style="float:right;">Mobile</a></li>
					<li><a href="#" data-toggle="modal" data-target="#myModal2" style="float:right;">datacard</a></li>
					<li><a href="#" data-toggle="modal" data-target="#myModal1" style="float:right;">DTH</a></li>
					
					<?php
						if($id == null) {
					?>
					<li><a href="#" data-toggle="modal" data-target="#myModal4" style="float:right;">login</a></li>
					<li><a href="#" data-toggle="modal" data-target="#myModal5" style="float:right;">Signup</a></li>
					
					<?php
						} else {
							
					?>
					<li><a href="#" data-toggle="modal" data-target="#myModal4">profile</a></li>
					<li><a href="logout.php?backpage=<?php echo basename($_SERVER['PHP_SELF']);?>" style="float:right;">logout</a></li>
					<?php
						}
					?>
				</ul>
...
<div class="footer">
	<div class="container">
		<h2><a href="index.html">BuzzMovie</a></h2>
		<p>© 2016 Team 32 - Challengers. All Rights Reserved</p>
		<ul>
								...
								<div class="login">
									...
									<div class="login-right">
										<form method="POST" action="login_action.php">
											...
											<input type="hidden" name="backpage" value="<?php echo basename($_SERVER['PHP_SELF']);?>">
											<h4><a href="#">Forgot password</a> / <a href="#">Create new password</a></h4>
											<div class="single-bottom">
												<input type="checkbox" name="autologin" id="brand" value="">
